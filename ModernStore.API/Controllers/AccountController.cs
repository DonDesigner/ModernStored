...
namespace ModernStore.API.Controllers
{
    public class AccountController : BaseController
    {
        ...
        private readonly JsonSerializerSettings _serializerSettings; //BUG - o Json estava vindo os os dados em Maiusculos e Minisculos
        ...
        public AccountController(IOptions<TokenOptions> jwtoptions ,IUow uow, ICustomerRepository repository ) : base(uow)
        {
            ...
            //Essa parte apenas pra resolver o BUG que traz maiusculos no JSON
        ...
        //faz uma validação dos Token Options
        private static void ThrowIfInvalidOptions(TokenOptions options)
        {
            if (options == null) throw new ArgumentNullException(nameof(options));

            if (options.ValidFor <= TimeSpan.Zero)
                throw new ArgumentNullException("O período deve ser maior que zero", nameof(TokenOptions.ValidFor));
        ...
        //montar ou fazer com que a data fique no formato UNIX
